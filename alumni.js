...
const app = Vue.createApp({
    data() {
      return {
        selectedCategory: 'Senior Portfolio',
        categories: ['Senior Portfolio', 'Notable Sites', 'NJIT Projects'],
        websitesData: {
          "Senior Portfolio": [
            {
              img: "img/Adobe Express - file (1).png",
          ...
          "Notable Sites": [
            {
              ...
              },
              {
                ...
                link: "https://mreiss97.github.io/Bagel-World1/"
              },
              {
                img: "img/coco.png",
